...
// =====================================================================
// === МОЄ (НОВЕ): розширена база знань з довгими відповідями ===
// =====================================================================
const baseKnowledge = [
  {
    ...
    answerLong:
`Фігура має 24 вершини, тому що ця кількість відповідає числу всіх можливих перестановок чотирьох елементів. У математиці це записується як 4! (4 факторіал), що дорівнює 24.

Іншими словами, кожна вершина відповідає певному порядку елементів, а всі можливі порядки утворюють 24 унікальні комбінації.`
  },

  {
    ...
    answerLong:
`Ребро в цій фігурі з'єднує дві вершини, які відповідають перестановкам, що відрізняються лише однією операцією — транспозицією сусідніх елементів.

Це означає, що між такими вершинами існує мінімальна зміна, тому вони вважаються безпосередньо пов'язаними.`
  },

  {
    ...
    answerLong:
`Загалом структура містить 14 граней: 8 трикутних і 6 чотирикутних. Така комбінація виникає природно з того, як вершини та ребра поєднують між собою різні перестановки.

Грані утворюють замкнені області між ребрами, створюючи впорядковану комбінацію простих багатокутників.`
  },

  {
    ...
    answerLong:
`Центр фігури можна описати точкою (2.5, 2.5, 2.5). Це середина між усіма координатами вершин у просторі.

Таке значення виходить із рівномірного розподілу точок, що формують фігуру.`
  }
];

// =====================================================================
// === МОЄ (НОВЕ): локальна пам’ять (навчання) ===
// =====================================================================
...
// =====================================================================
// === МОЄ (НОВЕ): "розумний" пошук відповіді + рейтинг ===
// =====================================================================
...
// =====================================================================
// === МОЄ (НОВЕ): команда навчання бота ===
// =====================================================================
...
// =====================================================================
// === МОЄ (НОВЕ): анімація машинопису (typing) ===
// =====================================================================
...
function initChat() {
  ...
  $('#send').onclick = async () => {
    ...
    setTimeout(async () => {
      ...
      // створюємо контейнер для машинопису
