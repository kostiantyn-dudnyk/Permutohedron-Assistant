...
const quizDB = [
  ...
  { q: "Переставлення з повтореннями - це:", a: "Упорядкована вибірка всіх елементів з заданої мультимножини;", opts: ["Упорядкована вибірка всіх елементів з заданої мультимножини;","Упорядкована вибірка з заданої множини будь-якої меншої, ніж є в множині, кількості елементів;","Неупорядкована вибірка всіх елементів з заданої множини;","Упорядкована вибірка з заданої мультимножини будь-якої меншої, ніж є в мультимножині, кількості елементів;","Упорядкована вибірка всіх елементів з заданої множини."] },
  { q: "Мультимножиною називається?", a: "Набір елементів, кожен з яких має свою кількість повторень;", opts: ["Набір елементів, кожен з яких має свою кількість повторень;","Набір елементів, взятих по одному разу;","Набір елементів, кожен яких обов'язково має однакову кількість повторень;","Упорядкована вибірка всіх елементів з заданої мультимножини;","Набір однакових елементів;","Набір елементів, в якому певна кількість елементів повторюється по разу, а певна - по кілька раз."] },
  { q: "Переставлення без повторень - це:", a: "Упорядкована вибірка всіх елементів з заданої множини.", opts: ["Упорядкована вибірка всіх елементів з заданої множини.","Упорядкована вибірка з заданої множини будь-якої меншої, ніж є в множині, кількості елементів;","Неупорядкована вибірка всіх елементів з заданої множини;","Упорядкована вибірка всіх елементів з заданої мультимножини;","Упорядкована вибірка з заданої мультимножини будь-якої меншої, ніж є в мультимножині, кількості елементів;"] },
  { q: "Розміщення без повторень - це:", a: "Упорядкована вибірка з заданої множини будь-якої меншої, ніж є в множині, кількості елементів;", opts: ["Неупорядкована вибірка всіх елементів з заданої множини;","Упорядкована вибірка всіх елементів з заданої мультимножини;","Упорядкована вибірка з заданої множини будь-якої меншої, ніж є в множині, кількості елементів;","Упорядкована вибірка з заданої мультимножини будь-якої меншої, ніж є в мультимножині, кількості елементів;","Упорядкована вибірка всіх елементів з заданої множини."] },
  { q: "Загальне розміщення - це:", a: "Упорядкована вибірка з заданої мультимножини будь-якої меншої, ніж є в мультимножині, кількості елементів;", opts: ["Упорядкована вибірка з заданої множини будь-якої меншої, ніж є в множині, кількості елементів;","Неупорядкована вибірка всіх елементів з заданої множини;","Упорядкована вибірка всіх елементів з заданої мультимножини;","Упорядкована вибірка з заданої мультимножини будь-якої меншої, ніж є в мультимножині, кількості елементів;","Упорядкована вибірка всіх елементів з заданої множини."] },
  { q: "Розміщення з необмеженими повтореннями - це:", a: "Упорядкована вибірка деякої кількості елементів з мультимножини, де кратність кожного з них не менше кількості елементів;", opts: ["Неупорядкована вибірка всіх елементів з заданої множини;","Упорядкована вибірка деякої кількості елементів з мультимножини, де кратність кожного з них не менше кількості елементів;","Неупорядкована вибірка деякої кількості елементів з заданої множини;","Неупорядкована вибірка деякої кількості елементів з заданої мультимножини;","Упорядкована вибірка деякої кількості елементів з мультимножини, де кратність кожного з них менше кількості елементів вибірки."] },
  { q: "Сполучення без повторень - це:", a: "Неупорядкована вибірка деякої кількості елементів з заданої множини;", opts: ["Неупорядкована вибірка деякої кількості елементів з заданої множини;","Неупорядкована вибірка всіх елементів з заданої множини;","Неупорядкована вибірка деякої кількості елементів з заданої мультимножини;","Упорядкована вибірка деякої кількості елементів з мультимножини, де кратність кожного з них не менше кількості елементів;","Упорядкована вибірка деякої кількості елементів з мультимножини, де кратність кожного з них менше кількості елементів вибірки."] },
  { q: "Сполучення з повтореннями - це:", a: "Неупорядкована вибірка деякої кількості елементів з заданої мультимножини;", opts: ["Неупорядкована вибірка деякої кількості елементів з заданої мультимножини;","Неупорядкована вибірка всіх елементів з заданої множини;","Неупорядкована вибірка деякої кількості елементів з заданої множини;","Неупорядкована вибірка деякої кількості елементів з мультимножини, де кратність кожного з них не менше кількості елементів;","Упорядкована вибірка деякої кількості елементів з мультимножини, де кратність кожного з них менше кількості елементів вибірки."] },
  { q: "Встановити відповідність між вибіркою та її назвою, якщо множина 𝐺, з якої вибирають така: 𝐺 ={1,2,3,4,5} - упорядкована вибірка (1, 3, 5, 2, 4); Відповіді:", a: "переставлення без повторень;", opts: ["переставлення без повторень;","переставлення з повтореннями;","розміщення без повторень;","розміщення з необмеженими повтореннями;","загальне розміщення;"] },
  { q: "В задачі упакування прямокутників кількість смужок 7, кількість прямокутників 15. Скільки елементів має мультимножина 𝐺 в моделі цієї задачі?", a: "63", opts: ["7","63","9","15","22"] },
  { q: "Якою задачею є модель 4 задачі упакування прямокутників:", a: "лінійною умовною частково комбінаторною на переставленнях;", opts: ["нелінійною безумовною на переставленнях;","лінійною умовною частково комбінаторною на переставленнях;","нелінійною умовною на переставленнях;","нелінійною умовною частково комбінаторною на переставленнях;","лінійною умовною повністю комбінаторною на переставленнях."] },
  { q: "В задачі обслуговування з набором 7 заявок з часами обслуговування 1, 2, 2, 3, 4, 4, 5 та 𝐿 =13, яким буде максимальна кількість 𝑄 заявок, що може обслуговувати один пристрій:", a: "5", opts: ["5","7","6","4","3"] },
  { q: "Будь-яка матрична гра", a: "має розв'язок в мішаних стратегіях;", opts: ["має розв'язок в мішаних стратегіях;","має розв'язок в чистих стратегіях;","не має розв'язку ні в мішаних стратегіях, ні в чистих стратегіях."] },
  { q: "Матрична гра еквівалентна парі двоїстих задач:", a: "лінійного програмування;", opts: ["лінійного програмування;","нелінійного програмування;","одна з яких лінійна, а інша - нелінійна."] },
  { q: "Матрична гра є грою", a: "з нульовою сумою;", opts: ["з нульовою сумою;", "з ненульовою сумою;","в якій деякі партії є партіями з нульовою сумою"] },
  { q: "Метод Брауна-Робінсон - це метод розв'язування матричних ігор", a: "ітераційний, наближений;", opts: ["ітераційний, наближений;","не ітераційний, наближений;","ітераційний, точний;","не ітераційний, точний.","Кількість фіксацій"] },
  { q: "Скільки парних перестановок у S₄?", a: "12", opts: ["6","12","24","8"] },
  { q: "Стратегію називають оптимальною, якщо?", a: "при багатократному повторенні гри вона забезпечує максимально можливий середній виграш;", opts: ["при багатократному повторенні гри вона забезпечує максимально можливий середній виграш;","при повторенні гри вона забезпечує виграш;","вона завжди забезпечує виграш;","Дублювання","і тільки, якщо вона відповідає сідловій точці гри."] },
  { q: "За критерієм максимального математичного очікування виграшу оптимальною вважають ту стратегію, при виборі якої математичне сподівання виграшу:", a: "максимальне;", opts: ["максимальне;","мінімальне;","максимінне;","мінімаксне."] },
  { q: "Принцип методу типу Брауна-Робінсон:", a: "майбутнє схоже на минуле;", opts: ["майбутнє схоже на минуле;","майбутнє може бути випадковим з заданими ймовірностями сценаріїв;","майбутнє не передбачуване."] },
  { q: "Припущення методу типу Брауна-Робінсон: гравці прагнуть", a: "збільшити свій виграш;", opts: ["збільшити свій виграш;","засіяти поле прибутковою культурою;","зменшити витрати на добрива;","зменшити витрати на перевезення."] },
  { q: "Який цикл має вигляд (1 2 3 4)?", a: "4-цикл", opts: ["3-цикл","4-цикл","2-цикл","Транспозиція"] },
  { q: "Яка задача оптимізації може розв'язуватися методом гілок та меж:", a: "будь-яка задача оптимізації", opts: ["будь-яка задача оптимізації", "тільки з лінійною цільовою функцією та лінійними обмеженнями;","тільки з лінійною цільовою функцією та нелінійними обмеженнями;","тільки з нелінійною функцією;","тільки з нелінійними обмеженнями;"] },
];
